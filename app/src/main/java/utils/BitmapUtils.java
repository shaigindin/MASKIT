...
import com.app.maskit_app.MainActivity;
...
public class BitmapUtils {
    ...
    public static Bitmap getBitmapFromGallery(Context context, Uri path, int width, int height) {
        ...
        // Decode bitmap with inSampleSize set
        options.inJustDecodeBounds = false;
        Bitmap bit = BitmapFactory.decodeFile(picturePath, options);
        bit = ExifUtil.rotateBitmap(picturePath, bit);
        MainActivity.filePath = picturePath;
        return bit;
    }
